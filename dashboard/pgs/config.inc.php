...
$PageOptions['ModuleNames']['T']                     = 'Techniek';
...
$CallingHome['Comment']                              = "Experimental reflector run by PA4TW. Located in Amsterdam, NL.";				// Comment. Max 100 character
$CallingHome['HashFile']                             = "/var/www/sites/ham.zuijlen.eu/tmp/callinghome.php";			// Make sure the apache user has read and write permissions in this folder.
$CallingHome['LastCallHomefile']                     = "/tmp/lastcallhome.php";			// lastcallhome.php can remain in the tmp folder 
$CallingHome['OverrideIPAddress']                    = "194.109.192.236";					// Insert your IP address here. Leave blank for autodetection. No need to enter a fake address.
$CallingHome['InterlinkFile']                        = "/home/dextra/xlxd/xlxd/xlxd.interlink";			// Path to interlink file
